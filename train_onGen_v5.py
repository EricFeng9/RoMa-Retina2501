...
from src.lightning.lightning_roma_superPoints import PL_RoMa
...
class RealDatasetWrapper(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            'vessel_weight0': torch.ones_like(fix_gray),
            'vessel_weight1': torch.ones_like(fix_gray),
...
class PL_RoMa_Baseline(PL_RoMa):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if 'vessel_weight0' in batch:
            data['vessel_weight0'] = batch['vessel_weight0']
...
def main():
    ...
    config.defrost()
    config.ROMA.USE_DINOV2 = False
    config.ROMA.SUPERPOINT_PATH = 'weights/superpoint_v1.pth'
